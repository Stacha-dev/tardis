...
final class HashTest extends TestCase
{
  ...
  /**
   * Test is successful if hash string is returned
   *
   * @return void
   */
  public function testHashCanBeGenerated()
  {
   ...
   * @return void
   */
  public function testHashCanBeVerified()
  {
   ...
   * @return void
   */
  public function testHashCantBeVerified()
  {
    $hash = Hash::getHash(self::SAMPLE_TEXT);
   ...
   * @return void
   */
  public function testInputStringTooLong()
  {
